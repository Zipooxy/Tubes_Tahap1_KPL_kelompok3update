...
namespace Tubes_Tahap1_KPL_kelompok3
{
    public class Siswa
    {
        ...
        public object RiwayatPelanggaran { get; internal set; }
        public int TotalPoin { get; internal set; }
        public int Id { get; internal set; }

        internal object RiwayatPelanggaran(Pelanggaran pelanggaran)
        {
    ...
    public class SiswaService
    {
        ...
        internal void TambahSiswa(Siswa siswa1)
        {
            throw new NotImplementedException();
        }
    }
